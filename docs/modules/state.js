...
export let MASTERS_DATA = [
  { id: 'm1', ycId: '5443758', name: 'Мария Соколова',  short: 'Мария С.',  role: 'Мастер ПМ и бровей', exp: '7 лет',  emoji: '👩', grad: 'linear-gradient(135deg,#F4B8CF,#E8729A)', cats: ['Брови', 'Губы', 'Глаза'],    fav: false, avail: true,  availText: '● Есть окна сегодня' },
...
export const state = {
  ...
  dateISO: '',
  slot: '14:00',
  masterPreSelected: false,
  _masterJustSelected: false,
  masterName: null,
  _mastersAll: false,
